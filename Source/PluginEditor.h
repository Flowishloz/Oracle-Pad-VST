...
private:
    ...
    // ── OSC 1 — 3-over-2 staggered grid (vol/shape/mix top | cut/dcmt bottom) ─
    juce::Slider osc1VolKnob,  osc1ShapeKnob, osc1MixKnob,
                 osc1CutKnob,  osc1DcmtKnob;
    juce::Label  osc1VolLbl,   osc1ShapeLbl,  osc1MixLbl,
                 osc1CutLbl,   osc1DcmtLbl;
    ...
    std::unique_ptr<SliderAttachment>
        aOsc1Vol, aOsc1Shape, aOsc1Mix, aOsc1Cut, aOsc1Dcmt,
